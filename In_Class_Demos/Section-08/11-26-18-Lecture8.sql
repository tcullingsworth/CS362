 ...
 *==============================================================================================*/
BULK INSERT CSV_Student 
   FROM 'C:\Users\trevor.cullingsworth\github\CS362\In_Class_Demos\Section-08\Students.csv' -- this needs to be a full path where you have your Students.csv file
   WITH   
      (  
         FIELDTERMINATOR =',',  
         ROWTERMINATOR ='\n'
...
INSERT INTO CSV_Student(FirstName, LastName)
SELECT FirstName, LastName
FROM Student;
 ...
 *==============================================================================================*/
UPDATE Section2_Student SET FirstName = 'UNKNOWN', 
							LastName = NULL;
...
WHERE Operation = 'Deleted';
 ...
 /*==============================================================================================
  * Exercise Questions LAB 4
  *==============================================================================================*/

/*
  1) Download the class Roster as CSV and create a new table to import the CSV to a new table Roster?

  -- upload CSV fileas well as SQL script
  -- just have first name, last name, email address
  -- don't have column heading in csv file
  ...
  2) Update sales to the same Sales agent to USASales table if the same agent has sales on both USA and Canada?
	 ...
	 example: update all students in class a and add 5 points to all students grade

	 UPDATE S SET S.grade = S.grade+5
	 FROM Students S
	 JOIN course C
	 WHERE C.ClassName = 'A'
  ...
  -- same principle as question 2 but instead of UPDATE use DELETE

  4) Insert a new sales agent ('20','YourName','YourLastName','123 Some Address','100','CASH') to USASales?
  5) We can be able to undo deleted records in SQL Server. (Ture/False)?  explain why - can use sql code
*/
